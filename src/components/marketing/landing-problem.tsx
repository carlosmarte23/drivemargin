...
export function LandingProblem() {
  return (
    <section className="motion-safe:timeline-view motion-safe:animate-fade-in-up motion-safe:animate-range-[entry_0%_cover_32%]">
      <div className="border-border bg-card/60 rounded-4xl border p-5 sm:p-6 lg:p-7">
        <div className="grid grid-cols-[auto_1fr] gap-x-5 lg:grid-cols-[auto_minmax(0,0.85fr)_minmax(0,1.15fr)] lg:items-center lg:gap-x-6">
          <AlertTriangle className="text-secondary mt-1 size-8 shrink-0 sm:size-10 lg:mt-0 lg:size-14" />

          <div className="max-w-2xl lg:max-w-sm">
            <h2 className="text-foreground text-2xl leading-tight font-semibold tracking-tight sm:text-3xl lg:text-4xl">
              Gross pay doesn&apos;t tell the full story.
            </h2>

            <p className="text-muted-foreground mt-3 text-base leading-7 sm:text-lg sm:leading-8 lg:hidden">
          ...
          <p className="text-muted-foreground hidden max-w-2xl text-base leading-7 sm:text-lg sm:leading-8 lg:block lg:justify-self-end">
